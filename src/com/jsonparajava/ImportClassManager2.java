 ...
 * Date: 10/21/12
 */
public class ImportClassManager2 extends BaseClassManager {
    public static final String PACKAGE_SEPERATOR = ".";
    public static final String REPLACE_PACKAGE_SEPERATOR = "\\" + PACKAGE_SEPERATOR;

    public ImportClassManager2(String baseDir, List<String> basePackageName) throws ClassNotFoundException, MalformedURLException {
