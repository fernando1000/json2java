...
public class Generator {
    ...
    public Generator(String outputDirectory, String packageName, String regexFilename, 
    									String importDirectory, List<String> importPackages, boolean promptForComplexValueTypes) throws IOException, ClassNotFoundException {
            ...
            if (!mapValue.isEmpty()) {
                ...
                if (mapKeyIsANumber) { // if the key is a number stay as a map
                    ...
                    stayAsMap = !askUserIfNewClassIsRequired(
                            ...
                            StringHelper.capFirstLetter(entryKey),
